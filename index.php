...
// التحقق من وضع الصيانة أو قريباً (للصفحات العامة فقط - لوحة التحكم تعمل دائماً)
$requestPath = $_SERVER['REQUEST_URI'] ?? '/';
$isAdminRequest = strpos($requestPath, '/admin') !== false;

if (!$isAdminRequest) {
    // وضع قريباً (Coming Soon)
    if (Settings::isComingSoonMode()) {
        include VIEWS_PATH . '/errors/coming_soon.php';
        exit;
    }
